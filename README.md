# Cypress Test Suite
This repository contains a test suite built with Cypress for testing ToolsQA Demo Site. This README will guide you through how to set up the project and run the tests.
